 ...
 */
	protected static function _buildEngine($name) {
		...
		if (empty(static::$_config[$name]['className'])) {
			throw new Error\Exception(sprintf('The "%s" catalog configuration does not exist.', $name));
		}
 ...
 * @param integer $count Count is used with $plural to choose the correct plural form.
